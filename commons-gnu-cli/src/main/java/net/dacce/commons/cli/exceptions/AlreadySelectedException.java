...
package net.dacce.commons.cli.exceptions;

import net.dacce.commons.cli.ExclusiveOptions;
...
public class AlreadySelectedException extends ParseException
{
	...
	private ExclusiveOptions group;
	 ...
	 * @since 1.2
	 */
	public AlreadySelectedException(ExclusiveOptions group, Option option)
	{
		this("The option '" + option.getName() + "' was specified but an option from this group "
	 ...
	 * @since 1.2
	 */
	public ExclusiveOptions getOptionGroup()
	{
		return group;
	}
